    ...
    <body>
      <header>
        ...
        <nav>
            ...
            <a class="navi" id="logout" href="#" onclick="showAlert()">Log out</a>
...
    }</script>
      ...
      <form method="POST">    
          <div class="radio-buttons">
            <label><input type="radio" name="flight-type" value="one-way" required> Oneway</label>
            <label><input type="radio" name="flight-type" value="returning" required>Returning</label>
          </div>
  
          <div class="input-row">
            <div class="From-to">
              <div class="departure-select">
                <input list="locations" id="From" name="From" placeholder="From">
              ...
              <div class="arrival-select">
                <input list="locations" id="To" name="To" placeholder="To">
      ...
      include 'config.php';
       ...
       <table>
        ...
        <div class="button-row">
          <button class="row-buttons" ><a href="./cancel.php" style="color: #ffffff; text-decoration: none;">Manage booking</a></button>
          <button class="row-buttons" ><a href="Chec-in.php" style="color: #ffffff; text-decoration: none;">Check in</a></button>
          <button class="row-buttons"><a href="frequentflyer.php" style="color: #ffffff; text-decoration: none;">Frequent flyer</a></button>
          <button class="row-buttons"><a href="contactus.php" style="color: #ffffff; text-decoration: none;">Contact us</a></button>
          <button class="row-buttons"><a href="fstatus.php" style="color: #ffffff; text-decoration: none;">Check flight status</a></button>
        </div>
