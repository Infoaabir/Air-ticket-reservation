    ...
    <section class="container">
      ...
      <form action="register.php" method="post" class="form">      
        ...
        <div class="input-box">
          ...
          <input type="text" name="firstName" placeholder="RANIL" required />
        </div>

        <div class="input-box">
          <label>Last Name</label>
          <input type="text" name="lastName" placeholder="RAJAPAKSHA" required />
        </div>
      </div>

        <div class="input-box">
          <label>Email Address</label>
          <input type="email" name="email" placeholder="ranilraja@gmail.com" required />
        </div>
        <div class="column">
          <div class="input-box">
      ...
      <div class="column">
        <div class="input-box select">
          <label>Preferred Language</label>
            ...
            <input type="tel" id="phoneNumber" name="phoneNumber" placeholder="4845219613" required />
            <script src="javascript\register.js"></script>
             </div>
            </div>
            <div class="checkbox" >
          <input type="checkbox" required/>
          <label>By creating an account you are agreeing to the terms and condition.</label>
        </div>
        <button name="submit">Create an account </button>
        <br><a href="login-aabir.php">Alredy a member? login here </a> 
      </form>
    </section>
    <footer>
